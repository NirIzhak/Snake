...
namespace Snake
{
    public partial class Form1 : Form
    {
        ...
        private void ScreenShot(object sender, EventArgs e)
        {
            ...
            caption.Text = "I Just Scored: " + score;
            caption.Font = new Font("Ariel", 12, FontStyle.Bold);
            caption.ForeColor = Color.DarkOrange;
        ...
        private void RestartGame()
        {
            ...
            Snake.Add(head); //adding the head patr of the snake to the list
        ...
        private void EatFood()
        {
            ...
            food = new Circle
            {
                X = rnd.Next(2, maxWidth),
                Y = rnd.Next(2, maxHeight)
            };
        ...
        private void GameOver()
        {
            ...
            {
                highscore = score;
                txtHiScore.Text = "High Score: " + highscore;
                txtHiScore.ForeColor = Color.DarkOrange;
            }
